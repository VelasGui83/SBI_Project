...
def get_clashes_v2(model, chain, limit=5):
    """
...
def get_clashes_v3(model, chain, limit=5):
    """
    ...
    max_radius = 0
    center = np.array(center_of_mass.center_of_mass_chain(chain, 'ATOM'), dtype=float)
